# The Quiet Realm - Codex Implementation Prompt v0.1

You are implementing a local, rules-correct virtual prototype for **The Quiet Realm: Seasons of Settlement**. Your goal is not final visual polish. Your goal is to create an inspectable MVP that can support local playtesting of the standard 1-4 player game.

## Source hierarchy

Use the provided source pack as authoritative, in this order:

1. `The_Quiet_Realm_Production_Rulebook_v1_4_2_River_Rules_Update.docx` - rules meaning and timing.
2. `The_Quiet_Realm_Codex_Source_Tables_v0_3_Map_Approved.xlsx` - structured source tables.
3. `The_Quiet_Realm_Codex_JSON_Exports_v0_4_Implementation_Ready.zip` - implementation-ready JSON exports derived from the source tables.
4. `The_Quiet_Realm_Codex_Simulation_Brief_v0_3_Map_Approved.docx` - implementation brief and project framing.
5. `The_Quiet_Realm_Hex_Map_Refinement_Workbook_v0_5_Codex_Default_Map_Approved.xlsx` - map review workbook and approved default map.
